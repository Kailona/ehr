OC.L10N.register(
    'ehr',
    {
        'Failed to initialize! Please contact your administrator!':
            'Initialisierung fehlgeschlagen! Bitte kontaktiere deinen Administrator!',
        'FHIR Server': 'FHIR-Server',
        'FHIR is required to store health data. Basic HTTP Authentication is currently supported.':
            'FHIR ist erforderlich, um Gesundheitsdaten zu speichern. Die Standard-HTTP-Authentifizierung wird derzeit unterstützt.',
        'Base URL': 'Basis-URL',
        ...
        'An error occurred while importing data. Please contact your administrator.':
            'Es ist ein Fehler beim Importieren der Daten aufgetreten. Bitte kontaktiere Deinen Administrator.',
        ...
        'Please update your health information for data accuracy.':
            'Bitte aktualisiere deinen Gesundheitsdaten für eine bessere Genauigkeit.',
        ...
        'I hereby request all data from my last exam to be uploaded to my personal health data archive on the Kailona platform. Please comply within the 30 day period as required by the Berufsordnung der Ärztekammern, §630g Abs. 2  BGB and Art. 15  Abs. 3 DSGVO.':
            'Ich beantrage hiermit, dass alle Daten meiner letzten Untersuchung in mein persönliches Gesundheitsdatenarchiv auf der Kailona-Plattform hochgeladen werden. Bitte komme der Aufforderung innerhalb der 30-Tage-Frist gemäß der Berufsordnung der Ärztekammern, §630g Abs. 2 BGB und Art. 15 Abs. 3 DSGVO nach.',
        'Unable to send health data request. Please set your email address in user profile settings!':
            'Senden der Anfrage deiner Gesundheitsdaten fehlgeschlagen. Bitte stelle deine E-Mail-Adresse in den Benutzerprofileinstellungen ein!',
        ...
        'Unable to send health data request. Please contact your administrator!':
            'Anfrage für Gesundheitsdaten fehlgeschlagen. Bitte kontaktiere deinen Administrator!',
        ...
        'Please confirm that the following patient information match with your records before sending health data!':
            'Bitte bestätige vor dem Senden der Gesundheitsdaten, dass die folgenden Patienteninformationen mit deinen Daten übereinstimmen!',
        ...
        'This is an automatically sent email, please do not reply.':
            'Dies ist eine automatisch gesendete E-Mail, bitte antworte nicht auf diese.',
