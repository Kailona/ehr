OC.L10N.register(
    'ehr',
    {
        'Failed to initialize! Please contact your administrator!':
            'Začenjanje je spodletelo! Stopite v stik s skrbnikom sistema.',
        'FHIR Server': 'Strežnik FHIR',
        'FHIR is required to store health data. Basic HTTP Authentication is currently supported.':
            'Strežnik FHIR omogoča shranjevanje podakov o zdravstvenem stanju. Trenutno je podprta osnovna overitev prek protokola HTTP.',
        ...
        'An error occurred while importing data. Please contact your administrator.':
            'Med uvažanjem podatkov je prišlo do napake. Stopite v stik s skrbnikom sistema.',
        ...
        'Please update your health information for data accuracy.':
            'Posodobite zdravstveni karton za večjo natančnost podatkov.',
        ...
        'I hereby request all data from my last exam to be uploaded to my personal health data archive on the Kailona platform. Please comply within the 30 day period as required by the Berufsordnung der Ärztekammern, §630g Abs. 2  BGB and Art. 15  Abs. 3 DSGVO.':
            'S tem sporočilom potrjujem oddajo zahtevka za prenos podatkov mojega zadnjega pregleda pri zdravniku v moj osebni karton zdravstvenih podatkov, zbranem v okolju Kailona. Izvedbo prenosa podatkov pričakujem v zakonsko določenem roku. ',
        'Unable to send health data request. Please set your email address in user profile settings!':
            'Pošiljanje zahtevka na prenos podatkov je spodletelo. Med nastavitvami je treba vpisati ustrezen elektronski naslov.',
        ...
        'Unable to send health data request. Please contact your administrator!':
            'Pošiljanje zahtevka na prenos podatkov je spodletelo. Stopite v stik s skrbnikom sistema.',
