OC.L10N.register(
    'ehr',
    {
        'Failed to initialize! Please contact your administrator!':
            'Nie udało się uruchomić! Skontaktuj się z administratorem!',
        'FHIR Server': 'Serwer FHIR',
        'FHIR is required to store health data. Basic HTTP Authentication is currently supported.':
            'FHIR jest wymagane do przechowywania danych dotyczących zdrowia. Obecnie obsługiwane jest podstawowe uwierzytelnianie HTTP.',
        ...
        'An error occurred while importing data. Please contact your administrator.':
            'Wystąpił błąd podczas importowania danych. Skontaktuj się z administratorem.',
        ...
        'Please update your health information for data accuracy.':
            'Zaktualizuj swoje dane zdrowotne, aby dane były aktualne.',
        ...
        'Please confirm that the following patient information match with your records before sending health data!':
            'Przed wysłaniem danych dotyczących zdrowia potwierdź, że poniższe informacje o pacjencie są zgodne z Twoimi danymi!',
        'Patient Name: %s': 'Imię pacjenta: %s',
        'Patient Email: %s': 'Adres e-mail pacjenta: %s',
        'Upload Health Data': 'Wyślij dane zdrowotne',
        'This is an automatically sent email, please do not reply.':
            'To jest wiadomość e-mail wysłana automatycznie, prosimy nie odpowiadać na nią.',
