OC.L10N.register(
    'ehr',
    {
    "Failed to initialize! Please contact your administrator!" : "Impossìbile a aviare! Cuntata s'amministratzione!",
    "FHIR Server" : "Serbidore FHIR",
    "FHIR is required to store health data. Basic HTTP Authentication is currently supported." : "FHIR rechertu pro memorizare is datos sanitàrios. A immoe est suportada s'autenticatzione de base.",
    ...
    "An error occurred while importing data. Please contact your administrator." : "B'at àpidu un'errore importende is datos. Cuntata a s'amministratzione.",
    "Add More Files" : "Agiunghe àteros archìvios",
    "Drag and Drop Files" : "Traga e iscapa is archìvios",
    "Patient Profile" : "Profilu patziente",
    "Welcome" : "Ti donamus sa benebènnida",
    "New Patient Profile" : "Profilu patziente nou",
    "Please update your health information for data accuracy." : "Agiorna is datos sanitàrios tuos pro chi siant pretzisos.",
    "Enjoy your private health platform, Kailona!" : "Ispàssia·ti in sa prataforma sanitària privada tua, Kailona!",
    "Name" : "Nùmene",
    "Birth Date" : "Die de nàschida",
    "Delete" : "Cantzella",
    "Confirm" : "Cunfirma",
    ...
    "Message to Provider:" : "Messàgiu a su frunidore",
    "Send Request" : "Imbia rechesta",
    "Timeline" : "Lìnia de tempus",
    "self" : "deo",
    "Select Date" : "Seletziona data",
    "Select Date/Time" : "Seletziona data/ora",
    "No data available" : "Perunu datu a disponimentu",
    "Steps" : "Passos",
    "Distance" : "Distàntzia",
    "Calories" : "Calorias",
    "Edit" : "Modìfica ",
    ...
    "Age" : "Edade",
    "Body Mass Index" : "Ìnditze de massa de su corpus",
    "Height" : "Altura",
    "Weight" : "Pesu",
    "Body Height" : "Altura de su corpus",
    ...
    "Diastolic Blood Pressure" : "Pressione de is artèrias diastòlica",
    "Heart Rate" : "Ritmu de su coro",
    "Body Temperature" : "Temperatura de su corpus",
    "Oxygen Saturation (SpO2)" : "Saturatzione de s'ossìgenu (SpO2)",
    "Vitals" : "Vitals",
    "Add New Vitals" : "Agiunghe sinnos vitales noos",
    "Update Vitals" : "Agiorna sinnos vitales",
    "Health Data Request" : "Rechesta de datos sanitàrios",
    "This is health data request from %s" : "Custa es sa rechesta de datos sanitàrios de %s",
    "Please confirm that the following patient information match with your records before sending health data!" : "Cunfirma chi is informatziones sanitàrias in fatu currispondent cun is registros tuos in antis de imbiare is datos!",
    "Patient Name: %s" : "Nùmene patziente: %s",
    "Patient Email: %s" : "Indiritzu de posta de su patziente: %s",
    "Upload Health Data" : "Càrriga datos sanitàrios",
    "This is an automatically sent email, please do not reply." : "Custu est unu messàgiu de posta automàticu, non rispondas.",
    "EHR (Electronic Health Records)" : "EHR (registros sanitàrios eletrònicos)",
    "EHR" : "EHR",
    "Kailona: Personal Health Records" : "Kailona: Registros sanitàrios personales",
    "The Kailona Personal Health Record allows you to regain control over your health data. We provide an open source platform that allows everyone to add plugins and make improvements.\n\nIt helps you aggregate, manage, securely share and visualize your health data including lab data, medical images, FHIR data from hospitals, vital signs, nutritional and activity data.\n\nThis app works with a FHIR server. Please read the [documentation](https://docs.kailona.org/docs/#installation) to learn more about that.\n\n**Note that this app is under alpha development!**" : "Su registru sanitàriu personale Kailona ti permitit de controllare is datos sanitàrios tuos. Est una prataforma de còdighe abertu pro chi siat possìbile a ddu megiorare e a ddi agiunghere plugin.\n\nTi serbit pro regòllere, gestire, cumpartzire e visualizare in seguresa is datos sanitàrios, comente datos de laboratòriu, radiografias, datos FHIR dae s'ospedale, sinnos vitales, datos de s'atividade e de sa nutritzione.\n\nCusta aplicatzione funtzionat cun unu serbidore FHIR. Leghe sa [documentation](https://docs.kailona.org/docs/#installation) pro nd'ischire de prus.\n\n**Custa aplicatzione est suta isvilupu alpha!**"
},
