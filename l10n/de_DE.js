OC.L10N.register(
    'ehr',
    {
        'Failed to initialize! Please contact your administrator!':
            'Initialisierung fehlgeschlagen! Bitte kontaktieren Sie Ihren Administrator!',
        ...
        'An error occurred while importing data. Please contact your administrator.':
            'Es ist ein Fehler beim Importieren der Daten aufgetreten. Bitte den Administrator kontaktieren.',
        ...
        'Please update your health information for data accuracy.':
            'Bitte aktualisieren Sie Ihre Gesundheitsdaten für eine bessere Genauigkeit.',
        ...
        'I hereby request all data from my last exam to be uploaded to my personal health data archive on the Kailona platform. Please comply within the 30 day period as required by the Berufsordnung der Ärztekammern, §630g Abs. 2  BGB and Art. 15  Abs. 3 DSGVO.':
            'Ich beantrage hiermit, dass alle Daten meiner letzten Untersuchung in mein persönliches Gesundheitsdatenarchiv auf der Kailona-Plattform hochgeladen werden. Bitte kommen Sie der Aufforderung innerhalb der 30-Tage-Frist gemäß der Berufsordnung der Ärztekammern, §630g Abs. 2 BGB und Art. 15 Abs. 3 DSGVO nach.',
        'Unable to send health data request. Please set your email address in user profile settings!':
            'Senden der Anfrage Ihrer Gesundheitsdaten fehlgeschlagen. Bitte tragen Sie Ihre E-Mail-Adresse in den Benutzerprofileinstellungen ein!',
        ...
        'Please confirm that the following patient information match with your records before sending health data!':
            'Bitte bestätigen Sie vor dem Versenden der Gesundheitsdaten, dass die folgenden Patienteninformationen mit Ihren Daten übereinstimmen!',
        ...
        'This is an automatically sent email, please do not reply.':
            'Dies ist eine automatisch gesendete E-Mail, bitte antworten Sie nicht auf diese.',
