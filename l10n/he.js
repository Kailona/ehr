OC.L10N.register(
    'ehr',
    {
        ...
        'FHIR is required to store health data. Basic HTTP Authentication is currently supported.':
            'יש צורך ב־FHIR כדי לאחסן נתוני בריאות. כרגע יש תמיכה באימות HTTP בסיסי.',
        'Base URL': 'כתובת בסיס',
        Username: 'שם משתמש',
        Password: 'ססמה',
        ...
        'Unable to send health data request. Please set your email address in user profile settings!':
            'לא ניתן לשלוח את בקשת נתוני הבריאות. נא להגדיר את כתובת הדוא״ל שלך בהגדרות פרופיל המשתמש!',
        ...
        'Unable to send health data request. Please contact your administrator!':
            'לא ניתן לשלוח בקשת נתוני בריאות. נא ליצור קשר עם ההנהלה!',
        ...
        'Please select at least one': 'אנא בחר לפחות אחד',
    },
