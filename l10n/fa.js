OC.L10N.register(
    "ehr",
    {
    "Failed to initialize! Please contact your administrator!" : "Failed to initialize! Please contact your administrator!",
    ...
    "Username" : "نام کاربری",
    "Password" : "کلمه عبور",
    "Google Fit Synchronize" : "Google Fit Synchronize",
    "You can synchronize your Google Fit Application data. Just need to set your client id here." : "You can synchronize your Google Fit Application data. Just need to set your client id here.",
    ...
    "Data not found on the related date to export." : "Data not found on the related date to export.",
    "${fromName}" : "${fromName}",
    ...
    "This is health data request from %s" : "This is health data request from %s",
    ...
    "Health Data Export" : "Health Data Export",
    "See Health Data" : "See Health Data",
